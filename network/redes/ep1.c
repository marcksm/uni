...
//int Read (char rm[][MAXLINE+1]);
//void Write (char *pre, char *s);
    ...
    * conexões e processamento de cada uma individualmente */
	for (;;) {
      ...
      if ( (childpid = fork()) == 0) {
         ...
         SENDreset ();
         SENDinsertline (MSGstart()); //envia msg inicial
         CLIENTwrite ();
         while ((n = CLIENTread (sm)) > 0) {
           CLIENTrequest (sm);
         }
         SENDreset ();
         SENDinsertline (MSGend()); //envia msg final
         CLIENTwrite ();
         /* ========================================================= */
         /* ========================================================= */
         /*                         EP1 FIM                           */
