...
class SeminarsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create seminar" do
    assert_difference('Seminar.count') do
      post seminars_url, params: { seminar: { date: @seminar.date, description: @seminar.description, name: @seminar.name, place: @seminar.place, seminar_id: @seminar.seminar_id } }
    end
  ...
  test "should update seminar" do
    patch seminar_url(@seminar), params: { seminar: { date: @seminar.date, description: @seminar.description, name: @seminar.name, place: @seminar.place, seminar_id: @seminar.seminar_id } }
