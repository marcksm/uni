...
public class RedBlackBST<Key extends Comparable<Key>, Value> {
    ...
    public Value getAdd (){ return cache.val; }
    public void add (Value val) { cache.val = val; }
    ...
    ***************************************************************************/
    ...
    public Value get(Key key) {
        ...
        if (cache != null && cache.key == key) return cache.val;
        return get(root, key);
    }
    ...
    public boolean contains(Key key) {
        if (cache != null && key == cache.key) return true;
        return get(key) != null;
    }
...
//        root = put(root, key, val);
        if (cache != null) { cache.val = val; cache = null; }
        else {
           root = put(root, key, val);
           root.color = BLACK;
        }
